...
const LoginSignUpHeader = () => (
    <div className='h-full max-w-4xl mx-auto flex flex-col justify-center'>
        <header>
            <h1 className={'border-8 p-3 rounded border-blue-300 text-center text-4xl font-bold text-blue-300'}>Cut Your Hair With Best <Link className='border-b-2 border-blue-300' to='/home'>Barbers</Link></h1>
